...
require (
	github.com/HellDarkK/caddy-cfrl/cloudflare v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/HellDarkK/caddy-cfrl v0.0.0-20260217002156-413956601864 // indirect
